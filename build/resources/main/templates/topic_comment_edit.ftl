...
<div id="main">
    <div class="panel">
        ...
        <div class="inner post">
            ...
            <form id="create_topic_form" action="/topic/${comment.topicId}/comment/update" method="post">
                <fieldset>
                    <span id="topic_create_warn"></span>
                    <div class="markdown_editor in_editor">
                        <div class="markdown_in_editor">
                            <textarea class="editor" name="content" rows="20">${comment.content}</textarea>
                            <div class="editor_buttons">
                                <input type="submit" class="span-primary submit_btn" data-loading-text="提交中" value="提交">
                            </div>
                        </div>
                    </div>
                    <input type="hidden" name="id" placeholder="id" value="${comment.id}">
